...
::: {.cell tbl-cap="Ocupación de plazas de acuerdo a género" #tbl-table_PLZOCU_SEXO}
```{r, table_PLZOCU_SEXO, echo = FALSE, results = "asis"}
epi_table_to_latex("table_PLZOCU_SEXO.txt",
                   caption = NULL  # caption set in tbl-cap above
                   )
```
:::
...
<!-- TO DO: would need to add the following to all tables in order to reference them: -->
<!-- ::: {.cell tbl-cap="xxx" #tbl-sum_factors} -->
<!-- caption = NULL  # caption set in tbl-cap above -->
<!-- ::: -->
<!-- eg See @tbl-sum_factors for yyy -->
...
![Gráfico de barras por Delegación](plots_bar_num_DELEGACION.pdf)

![Gráfico de barras por Unidad](plots_bar_num_CLASIF_UNIDAD.pdf)
...
![Gráfico de barras de acuerdo a la Marca de Baja](plots_bar_num_MCABAJA.pdf)
