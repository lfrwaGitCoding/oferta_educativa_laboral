...
<!-- TO DO: -->
<!-- File needs to be in pwd -->
<!-- In _quarto.yml set params to true for: -->
::: {.content-visible when-meta="meta.extended_report"}
{{< include _extended_ord_meds_Qna_17_2024.qmd >}}
:::

\clearpage
\FloatBarrier

<!-- Next section is for landscape pages: -->
\afterpage{
  \thispagestyle{empty}
}
...
::: {.cell tbl-cap="Resumen de variables de identificación" tbl-pos="h" id="tbl-sum_chars"}
...
::: {.cell tbl-cap="Resumen de variables numéricas" tbl-pos="h" id="tbl-sum_stats"}
```{r, echo = FALSE, results = "asis"}
...
::: {.cell tbl-cap="Resumen de variables de tipo fecha" tbl-pos="h" id="tbl-sum_dates"}
```{r, echo = FALSE, results = "asis"}
...
<!-- Next table gets placed in a new page, which then gets rendered with header and footer, so repeat landscpae div: -->
\clearpage
\afterpage{
  \thispagestyle{empty}
}
...
::: {.landscape}
::: {.cell tbl-cap="Resumen de variables categóricas" tbl-pos="h" id="tbl-sum_factors"}
```{r, echo = FALSE, results = "asis"}
...
::: {layout="[[-5,45,45,-5], [-25,50,-25]]"}
![Histograma de Edad](plots_hist_num_EDAD.pdf){#fig-hist_edad}

![Diagrama de cajas de Edad](plots_box_num_EDAD.pdf){#fig-box_edad}
...
::: {.cell tbl-cap="Ocupación de plazas por Escolaridad" tbl-pos="h" id="tbl-PLZOCU_ESCOLARIDAD"}
...
::: {.cell tbl-cap="Ocupación de plazas de acuerdo a Clasificación por Categoría" tbl-pos="h" id="tbl-PLZOCU_DESCRIP_CLASCATEG"}
...
<!-- In _quarto.yml set params to true for: -->
::: {.content-visible when-meta="meta.extended_report"}
![Gráfico de barras de Especialidades más Frecuentes por OOAD](plot_bar_med_esp_OOAD_top.pdf)
:::

::: {.cell tbl-cap="Áreas de Responsabilidad con más de diez plazas y mayor vacancia" tbl-pos="h" id="tbl-top_PLZOCU_NOMBREAR"}
...
::: {.cell tbl-cap="Categorías con más de diez plazas y mayor vacancia" tbl-pos="h" id="tbl-top_PLZOCU_CATEGORIA"}
...
::: {.cell tbl-cap="Servicios con más de diez plazas y mayor vacancia" tbl-pos="h" id="tbl-top_PLZOCU_DESCRIPCION_SERVICIO"}
...
![Gráfico de barras de acuerdo al Tipo de Contrato](plots_bar_num_DescripcionTC.pdf)
...
::: {.cell tbl-cap="Ocupación de plazas de acuerdo al Tipo de Confianza" tbl-pos="h" id="tbl-PLZOCU_TipoConfianza"}
...
<!-- TO DO: re-do as only if occupied, so no vacants -->
...
::: {.cell tbl-cap="Ocupación de plazas de acuerdo a la Descripción del Turno" tbl-pos="h" id="tbl-PLZOCU_DESCRIP_TURNO"}
...
::: {.cell tbl-cap="Horarios con más de diez plazas y mayor vacancia" tbl-pos="h" id="tbl-PLZOCU_DESCRIP_HORARIO"}
...
::: {.cell tbl-cap="Dependencias con más de diez plazas y mayor vacancia" tbl-pos="h" id="tbl-top_PLZOCU_DEPENDENCIA"}
...
::: {.cell tbl-cap="Ocupación de plazas por Delegación" tbl-pos="h" id="tbl-PLZOCU_DELEGACION"}
...
::: {.cell tbl-cap="Ocupación de plazas de acuerdo a Clasificación por Unidad" tbl-pos="h" id="tbl-PLZOCU_CLASIF_UNIDAD"}
...
::: {.cell tbl-cap="Localidades con más de diez plazas y mayor vacancia" tbl-pos="h" id="tbl-top_PLZOCU_DESCRIP_LOCALIDAD"}
...
::: {.cell tbl-cap="Ocupación de plazas de acuerdo al Régimen de Jubilación de Pensiones" tbl-pos="h" id="tbl-PLZOCU_RJP"}
