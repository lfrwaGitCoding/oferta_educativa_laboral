...
<!-- Run if param extended report is true: -->
<!-- Needs 
Sys.setenv(QUARTO_PROFILE = "extended")
quarto::quarto_render("your_document.qmd", profile = "extended")
quarto render --profile extended
-->
