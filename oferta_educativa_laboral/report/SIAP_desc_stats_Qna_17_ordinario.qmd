...
![Histograma de Edad](plots_hist_num_EDAD.pdf)

<!-- ![Histograma de Edad](plots_hist_num_1.pdf){#fig-hist_edad fig-pos="h" fig-cap="Histograma de Edad"} -->
<!-- See @fig-hist_edad for yyy -->

![Diagrama de cajas de Edad](plots_box_num_EDAD.pdf)

![Gráfico de barras por Género](plots_bar_num_SEXO.pdf)

![Gráfico de barras por Escolaridad](plots_bar_num_ESCOLARIDAD.pdf)
...
<!-- TO DO: continue here -->
<!-- Change to outputs of one plot per page with var name -->
